...
class Producer extends Thread {
    ...
    void make() {
        ...
        while (bread != 5) {
            bread++;
            stringBuilder.append("Made  bread. Quantity: ").append(bread).append("\n");
        }
...
class Consumer extends Thread {
    ...
    void buy() {
        ...
        while (bread != 5) {
            ...
            stringBuilder.append("Consumer buys. Quantity: ").append(bread).append("Sellers Quantity : ").append(seller.getBread()).append("\n");
        }
        System.out.println(stringBuilder);
        System.out.println();
    }
    ...
    void eat() {
        ...
        while (bread > 0) {
            bread--;
            stringBuilder.append("Consumer uses. Quantity: ").append(bread).append("\n");
        }
        System.out.println(stringBuilder);
        System.out.println();
    }
